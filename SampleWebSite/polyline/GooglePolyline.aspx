<%@ Page Language="C#" MasterPageFile="~/GoogleMap.master" AutoEventWireup="false" CodeFile="GooglePolyline.aspx.cs"
    Inherits="polyline_GooglePolyline" CodeFileBaseClass="Artem.GoogleMap.WebSite.UI.PageBase" Title="GooglePolyline Reference"
    MetaDescription="GoogleMap Control - GooglePolyline Reference" MetaKeywords="software, freeware, open source, google maps api, googlemap control, polylines, asp.net custom control" %>
...
<asp:Content ContentPlaceHolderID="phDescription" runat="server">
    Wraps Google Maps API class GPolyline. This is a map overlay that draws a polyline on the map, using
    the vector drawing facilities of the browser if they are available, or an image overlay from Google
    servers otherwise.
    <p>
...
<asp:Content ContentPlaceHolderID="phProperties" runat="server">
    <ul class="props">
        <li><b>Bounds</b> - Gets or sets the bounds of polyline. Have in mind it requires an additional post back
            after polyline is loaded.</li>
        ...
        <li><b>Opacity</b> - Gets or sets the opacity of polyline. The opacity is given as a number between 0 and
            1. The line will be antialiased and semitransparent.</li>
        <li><b>Points</b> - Gets or sets the points of polyline.</li>
        <li><b>Weight</b> - Gets or sets the weight of polyline. The weight is the width of the line in pixels.</li>
    </ul>
</asp:Content>
<asp:Content ContentPlaceHolderID="phActions" runat="server">
    <ul class="props">
        <li><b>Hide</b> - Method to fire invokation of hide function of the GPolyline instance from the server-side
            code.</li>
        <li><b>Show</b> - Method to fire invokation of show function of the GPolyline instance from the server-side
            code.</li>
    </ul>
</asp:Content>
