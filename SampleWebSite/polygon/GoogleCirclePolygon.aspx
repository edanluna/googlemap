<%@ Page Language="C#" MasterPageFile="~/GoogleMap.master" AutoEventWireup="false" CodeFile="GoogleCirclePolygon.aspx.cs"
    Inherits="polygon_GoogleCirclePolygon" CodeFileBaseClass="Artem.GoogleMap.WebSite.UI.PageBase" Title="GoogleCirclePolygon Reference"
    MetaDescription="GoogleMap Control - GoogleCirclePolygon Reference" MetaKeywords="software, freeware, open source, google maps api, googlemap control, circle polygon, asp.net custom control" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="phContent" runat="Server">
    ...
    <h1>
        GoogleCirclePolygon Reference</h1>
    <p>
        Click on the map below to set the center point of circle polygon. Set the radius and click 'Draw' button
        the draw the polygon.</p>
    Point
