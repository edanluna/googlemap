<%@ Page Language="C#" MasterPageFile="~/GoogleMap.master" AutoEventWireup="false" CodeFile="GooglePolygon.aspx.cs"
    Inherits="polygon_GooglePolygon" CodeFileBaseClass="Artem.GoogleMap.WebSite.UI.PageBase" Title="GooglePolygon Reference"
    MetaDescription="GoogleMap Control - GooglePolygon Reference" MetaKeywords="software, freeware, open source, google maps api, googlemap control, polygons, asp.net custom control" %>
...
<asp:Content ContentPlaceHolderID="phDescription" runat="server">
    Wraps Google Maps API class GPolygon. This is very similar to a GPolyline, except that you can additionally
...
<asp:Content ContentPlaceHolderID="phProperties" runat="server">
    <ul class="props">
        <li><b>Bounds</b> - Gets or sets the bounds of polygon. Have in mind it requires an additional post back
            after polygon is loaded.</li>
        <li><b>FillColor</b> - Gets or sets the fill color of polygon. The color is given as a string that contains
            the color in hexadecimal numeric HTML style, i.e. #RRGGBB.</li>
        <li><b>FillOpacity</b> - Gets or sets the fill opacity of polygon. The opacity is given as a number between
            0 and 1. The line will be antialiased and semitransparent.</li>
        ...
        <li><b>StrokeColor</b> - Gets or sets the stroke color of polygon. The color is given as a string that contains
            the color in hexadecimal numeric HTML style, i.e. #RRGGBB.</li>
        <li><b>StrokeOpacity</b> - Gets or sets the stroke opacity of polygon. The opacity is given as a number
            between 0 and 1. The line will be antialiased and semitransparent.</li>
        <li><b>StrokeWeight</b> - Gets or sets the weight of polygon. The weight is the width of the line in pixels.</li>
    </ul>
</asp:Content>
<asp:Content ContentPlaceHolderID="phActions" runat="server">
    <ul class="props">
        <li><b>Hide</b> - Method to fire invokation of hide function of the GPolygon instance from the server-side
            code.</li>
        <li><b>Show</b> - Method to fire invokation of show function of the GPolygon instance from the server-side
            code.</li>
    </ul>
</asp:Content>
