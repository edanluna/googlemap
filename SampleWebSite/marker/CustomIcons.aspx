...
<asp:Content ID="Content1" ContentPlaceHolderID="phContent" runat="Server">
    ...
    <artem:GoogleMap ID="GoogleMap1" runat="server" Width="640px" Height="600px" Latitude="42.1229"
        Longitude="24.7879" Zoom="5" BorderStyle="Solid" BorderColor="#999999" BorderWidth="1">
        <Markers>
            <artem:GoogleMarker Address="sofia bulgaria" ImageUrl="~/images/arrow24.gif" IconSize="24,24"
                IconAnchor="12,24" Text="Sofia Bulgaria">
            </artem:GoogleMarker>
            <artem:GoogleMarker Address="athens greece" ImageUrl="~/images/rabbit.jpg" IconSize="60,75"
