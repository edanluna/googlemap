<%@ Page Language="C#" MasterPageFile="~/GoogleMap.master" AutoEventWireup="false" CodeFile="CaptureClick.aspx.cs"
    Inherits="map_CaptureClick" CodeFileBaseClass="Artem.GoogleMap.WebSite.UI.PageBase" 
    Title="GoogleMap Capture Click Sample"
    Description="GoogleMap Control - Capture Click Sample" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="phContent" runat="Server">
    ...
    <asp:UpdatePanel runat="server" ID="upTest">
        <ContentTemplate>
            ...
            <span id="__info" style="background-color: #EEE; color: #009; padding: 0px 4px 0px 4px; border: solid 1px #999;">
                Position</span>
            <hr style="visibility: hidden;" />
            <artem:GoogleMap ID="GoogleMap1" runat="server" Width="640px" Height="600px" Latitude="42.1229" Longitude="24.7879"
                Zoom="4" OnClientClick="__showInfo" BorderStyle="Solid" BorderColor="#999999" BorderWidth="1">
            </artem:GoogleMap>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
