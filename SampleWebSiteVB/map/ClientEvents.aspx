<%@ Page Title="GoogleMap Control - Clent Events" Language="C#" MasterPageFile="~/GoogleMap.master"
    AutoEventWireup="true" CodeFile="ClientEvents.aspx.cs" Inherits="map_ClientEvents" %>

<asp:Content ID="cntContent" ContentPlaceHolderID="phContent" runat="Server">
    <h1>
        GoogleMap Control - Clent Events
    </h1>
