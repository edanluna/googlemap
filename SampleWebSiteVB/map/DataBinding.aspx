<%@ Page Language="C#" MasterPageFile="~/GoogleMap.master" AutoEventWireup="false"
    CodeFile="DataBinding.aspx.cs" Inherits="map_DataBinding" CodeFileBaseClass="Artem.GoogleMap.WebSite.UI.PageBase"
    Title="GoogleMap Data Binding Sample" MetaDescription="GoogleMap Control - Data Binding Sample"
