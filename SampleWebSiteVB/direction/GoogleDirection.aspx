<%@ Page Language="C#" MasterPageFile="~/GoogleMap.master" AutoEventWireup="false"
    CodeFile="GoogleDirection.aspx.cs" Inherits="direction_GoogleDirection" CodeFileBaseClass="Artem.GoogleMap.WebSite.UI.PageBase"
    Title="GoogleDirection Reference" MetaDescription="GoogleMap Control - GoogleDirection Reference"
    MetaKeywords="software, freeware, open source, google maps api, googlemap control, directions, asp.net custom control" %>
