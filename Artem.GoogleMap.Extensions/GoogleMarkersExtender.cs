...
#region Resources
[assembly: WebResource("Artem.Web.UI.Controls.GoogleMarkers.GoogleMarkersBehavior.js", "text/javascript")] 
#endregion
namespace Artem.Web.UI.Controls {
    ...
    public class GoogleMarkersExtender : ExtenderControl {
        ...
        protected override IEnumerable<ScriptDescriptor> GetScriptDescriptors(System.Web.UI.Control targetControl) {
            ScriptBehaviorDescriptor descriptor = new ScriptBehaviorDescriptor("ArtemGoogleMap.GoogleMarkersBehavior", targetControl.ClientID);
        ...
        protected override IEnumerable<ScriptReference>GetScriptReferences() {
            yield return new ScriptReference("Artem.Web.UI.Controls.GoogleMarkers.GoogleMarkersBehavior.js", this.GetType().Assembly.FullName);
        } 
        #endregion
    }
}