<%@ Page Language="C#" MasterPageFile="~/GoogleMap.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="marker_GoogleMarker" CodeFileBaseClass="Artem.GoogleMap.WebSite.UI.PageBase"
    Title="GoogleMarker Reference" MetaDescription="GoogleMap Control - GoogleMarker Reference"
    MetaKeywords="software, freeware, open source, google maps api, googlemap control, markers, asp.net custom control" %>
    ...
    <script type="text/javascript">
        ...
        function addMarker(overlay, point) {
            if (point) {
                ...
                GoogleMap1.addMarker({ Latitude: point.lat(), Longitude: point.lng() }, true);
