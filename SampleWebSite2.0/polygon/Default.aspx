<%@ Page Language="C#" MasterPageFile="~/GoogleMap.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="polygon_GooglePolygon" CodeFileBaseClass="Artem.GoogleMap.WebSite.UI.PageBase"
    Title="GooglePolygon Reference" MetaDescription="GoogleMap Control - GooglePolygon Reference"
    MetaKeywords="software, freeware, open source, google maps api, googlemap control, polygons, asp.net custom control" %>
