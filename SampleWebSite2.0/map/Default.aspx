<%@ Page Language="C#" MasterPageFile="~/GoogleMap.master" AutoEventWireup="false"
    ...
    CodeFileBaseClass="Artem.GoogleMap.WebSite.UI.PageBase" Title="GoogleMap Control - Reference"
    MetaDescription=" Wraps Google Maps API as ASP.NET custom control. Offers extremely easy and fast way of adding Google Maps API support on your ASP.NET pages."
    MetaKeywords="google map control, googlemap control, google maps, asp.net custom control, software, freeware, open source, artembg, velio ivanov" %>

<asp:Content ID="cntContent" ContentPlaceHolderID="phContent" runat="Server">
    <h1>
        GoogleMap Control - Reference</h1>
    <p>
    ...
    <%--<artem:GoogleMarkersExtender ID="ext" TargetControlID="GoogleMap1" runat="server"/>--%>
</asp:Content>
