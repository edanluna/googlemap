<%@ Page Language="C#" MasterPageFile="~/GoogleMap.master" AutoEventWireup="false"
    CodeFile="PostbackPersistence.aspx.cs" Inherits="map_PostbackPersistence" CodeFileBaseClass="Artem.GoogleMap.WebSite.UI.PageBase"
    Title="GoogleMap Postback Persistence Sample" MetaDescription="GoogleMap Control - Postback Persistence Sample"
