<%@ Page Language="C#" MasterPageFile="~/GoogleMap.master" AutoEventWireup="false"
    CodeFile="ClientUpdate.aspx.cs" Inherits="map_ClientUpdate" CodeFileBaseClass="Artem.GoogleMap.WebSite.UI.PageBase"
    Title="GoogleMap Client Update Sample" Description="GoogleMap Control - Client Update Sample"
