<%@ Page Language="C#" MasterPageFile="~/GoogleMap.master" AutoEventWireup="false"
    CodeFile="StreetView.aspx.cs" Inherits="map_StreetView" CodeFileBaseClass="Artem.GoogleMap.WebSite.UI.PageBase"
    Title="GoogleMap Control - StreetView Mode" MetaDescription="This is a simple demo of GoogleMap Control StreetView mode enabled."
    MetaKeywords="google map control, googlemap control, google maps, street view, asp.net custom control, software, freeware, open source, artembg, velio ivanov" %>

<asp:Content ID="cntContent" ContentPlaceHolderID="phContent" runat="Server">
    <h1>
        GoogleMap Control - StreetView Mode
    </h1>
    <p>
        <fieldset>
