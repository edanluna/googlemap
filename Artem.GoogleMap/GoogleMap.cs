...
namespace Artem.Web.UI.Controls {
    ...
    public partial class GoogleMap : DataBoundControl, INamingContainer, IPostBackEventHandler {
        ...
        protected override void OnInit(EventArgs e) {
            ...
            if (this.EnableGoogleMapState) {
                string state = this.Page.Request[this.ClientID + "_State"];
                LoadGoogleMapState(state);
            }
        }
...
#if DEBUG
            ClientScriptProxy.RegisterClientScriptResource("Artem.Web.UI.Controls.Scripts.GoogleMap4.js");
#else
            ClientScriptProxy.RegisterClientScriptResource("Artem.Web.UI.Controls.Scripts.GoogleMap4.min.js");
#endif
